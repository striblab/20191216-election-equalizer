		...
		new WebpackDeployer({
		  environments: {
		    staging: {
		      region: 'us-west-1',
		      params: {
		        Bucket: 'static.startribune.com/staging/news/projects/all/20191216-election-equalizer/build',
		    ...
		    production: {
		      region: 'us-west-1',
		      params: {
		        Bucket: 'static.startribune.com/news/projects/all/20191216-election-equalizer/build',
		        DistributionId: 'BUCKETIDHERE'
		      }
		    }
		  },
