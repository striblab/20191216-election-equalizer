...
<div class="scenario first">
	...
	<p>So what happened? Trump credits his decision to visit Minnesota ahead of Election Day, often arguing that one more speech would have tipped him to victory. Clinton did not campaign in person or invest significant resources in the state.</p>
...
<div class="scenario second">
	...
	<p>To make a significant difference in 2020, Trump would not only need to turn out more people in those areas, he would likely also have to shift voters – such as independents – his way. Parts of greater Minnesota, including the Iron Range, have trended more deeply red in recent elections. The president has focused on northern Minnesota and emphasized how the region has benefited from his tariffs on imported steel. Trump visited Bemidji on Sept. 18, and Vice President Mike Pence, Donald Trump Jr. and Ivanka Trump have all made recent campaign stops in Duluth.</p>

	<p>In farm country, the Trump campaign has championed trade deals with Mexico and Canada that took effect in July. However, trade tensions with China have hurt farmers during Trump’s term, and an economic downturn amid the COVID-19 pandemic is creating an additional burden. In rural areas where there have been fewer coronavirus cases, campaigning Republicans have emphasized frustrations over Democratic Gov. Tim Walz’s pandemic regulations.</p>
